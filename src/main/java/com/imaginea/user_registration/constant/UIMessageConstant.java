...
public class UIMessageConstant {
    ...
    public static final String INSERT_USER_MSG = "Unable to insert user : ";
    public static final String DELETE_USER_MSG = "Unable to delete user : ";
    public static final String UPDATE_USER_MSG = "Unable to update user : ";
}
